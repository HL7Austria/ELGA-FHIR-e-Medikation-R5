...
Id: eMed-requests
Title: "ELGA e-Medication MedicationRequests (eMedRequest)"
...
* subject only Reference(http://hl7.at/fhir/HL7ATCoreProfiles/4.0.1/StructureDefinition/at-core-patient)
